...
#  python compare_edge_lists.py -r $ref -i $naive_nnls_result -o $naive_nnls_out -c coral
...
#  python compare_edge_lists.py -r $ref -i $regularized_nnls_result -o $regularized_nnls_out -c seagreen
#done
...
python compare_all_and_plot.py -i ../data/test_data/test1/results -r ../data/test_data/test1 -x 'Multiples of rank' -y 'L1 error' -o ../data/plots/line_factor.png -hue r-ary