...
python compare_all_and_plot.py -i ../data/test_data/test4/results -r ../data/test_data/test4/r3 -x threshold -y "L1 error" -style perturbation -o ../data/plots/line_r3_perturb_vs_threshold_all.png -hue method
#alternative
#python compare_all_and_plot.py -i ../data/test_data/test4/results -r ../data/test_data/test4/r3 -x perturbation -y "L1 error" -style threshold -o ../data/plots/line_r3_perturb_vs_threshold_all.png -hue method
